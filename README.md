...
4. **服務矩陣** — 三階方案卡，並列顯示。860px 以下垂直堆疊，**不摺疊、不隱藏**——三個價格的比較是這一頁的核心決策，不該在主要裝置上被藏在切換器後面。
...
6. **審核申請表單** — 側欄列出審核時間、後續流程、資料原則，以及 **Facebook 私訊**（[dream2walker](https://www.facebook.com/dream2walker)）給還沒準備好送申請、想先問一句的人。表單欄位依序為申請層級、姓名、Email、目前最大的系統性瓶頸、目前職位與年收級距（**選填**），以及索取策略指南的勾選。
