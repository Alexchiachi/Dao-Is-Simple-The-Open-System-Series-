...
7. **審核申請表單** — 側欄列出審核時間、後續流程、資料原則，以及 **Facebook 私訊**（[dream2walker](https://www.facebook.com/dream2walker)）給還沒準備好送申請、想先問一句的人。表單欄位依序為申請層級、姓名、Email、目前最大的系統性瓶頸、目前職位與年收級距（**選填**），以及索取策略指南的勾選。
