...
6. **審核申請表單** — 側欄列出審核時間、後續流程、資料原則，以及 **Facebook 私訊**（[dream2walker](https://www.facebook.com/dream2walker)）給還沒準備好送申請、想先問一句的人。表單欄位為申請層級、姓名、Email、目前職位與年收級距、目前最大的系統性瓶頸，以及索取策略指南的勾選。上方任一方案的按鈕都會自動帶入對應層級。送出後跳出確認視窗：「申請已送出，我們將於 48 小時內審核並寄發行前評估問卷」，並回報所申請的層級。
